...
public partial class SystemManagement_StocktakeTypeEdit : ECountBasePage
{
    ...
    private void bindBaseData(string typeID)
    {
        ...
        //if (model.StocktakePriority != null)
        //{
        //    this.ddlDefaultPriority.SelectedValue = model.StocktakePriority.PriorityID.ToString();
        //}
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        //{
        //    model.StocktakePriority = new StocktakePriority();
        //    model.StocktakePriority.PriorityID = int.Parse(this.ddlDefaultPriority.SelectedValue);
        //}

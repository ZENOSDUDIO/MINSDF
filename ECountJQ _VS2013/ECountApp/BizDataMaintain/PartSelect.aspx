<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PartSelect.aspx.cs" Inherits="BizDataMaintain_PartSelect" %>
...
<body>
    ...
    <div class="divContainer" style="height: 270px">
        ...
        <asp:GridView ID="gvParts" AutoGenerateColumns="False" Width="97%" runat="server"
            AllowPaging="false" OnPreRender="gvParts_PreRender" DataKeyNames="PartID" OnRowDataBound="GridView1_RowDataBound">
            <Columns>
                <asp:TemplateField HeaderText="选择">
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton1" runat="server" AutoPostBack="true" OnClick="lnkSelect_Click">选择</asp:LinkButton>
                    </ItemTemplate>

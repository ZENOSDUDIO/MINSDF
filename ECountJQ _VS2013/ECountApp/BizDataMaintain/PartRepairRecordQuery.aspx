<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PartRepairRecordQuery.aspx.cs" Inherits="BizDataMaintain_PartRepairRecordQuery" %>
...
<ContentTemplate>
        <SCS:Toolbar ID="Toolbar1" runat="server" CssClass="toolbar" EnableClientApi="true"
         ...
         <div class="divContainer" >
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlPlantID" runat="server"  Width = "152"/>
                        </td>
                        <td>
                            零件号
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDUNS1" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            返修供应商名称
                        </td>
         ...
         <div class="divContainer" style="height:330px">
                    <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server"  DataKeyNames="RecordID" OnPreRender="GridView1_PreRender"
